 ...
 * ║                                                                           ║
 * ║   This file lives at: ~/.config/opencode/plugins/swarm.ts                 ║
...
async function execTool(
  ...
  if (checkDoomLoop(ctx.sessionID, name, args)) {
    const errorMsg = `Doom loop detected: Tool ${name} called ${DOOM_LOOP_THRESHOLD} times with identical arguments. Aborting to prevent infinite loop.`;
